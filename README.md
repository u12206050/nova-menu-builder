...
Continuation of [OptimistDigital/Nova-Menu-Builder](https://github.com/optimistdigital/Nova-Menu-Builder). As opposed to the menu builder by InfinityEs, this package is mainly targeted towards the creation of headless content management systems and expects data to be returned through an API.
...
- Support for different languages using active `app()->getLocale()`
...
```bash
# Install the package
composer require day4/nova-menu-builder
...
public function tools()
{
    return [
        // ...
        new \Day4\MenuBuilder\MenuBuilder,
    ];
}
```
...
Create a class that extends the `Day4\MenuBuilder\Classes\MenuLinkable` class and register it in the config file.
...
use Day4\MenuBuilder\Http\Resources\MenuResource as BaseMenuResource;
